...
# comment3 = Comment.create(post: Post.second, user: User.second, text: 'Hi Marco!' )
# comment4 = Comment.create(post: Post.second, user: User.second, text: 'Hi Marco!' )
# comment5 = Comment.create(post: Post.third, user: User.third, text: 'Hi Mike!' )
# comment6 = Comment.create(post: Post.third, user: User.third, text: 'Hi Mike!' )  